  ...
  Foo:
    ...
    properties:
      id:
        type: "integer"
        format: "int64"
    x-nholuongut-group-version-kind:
    - group: group1
      version: v1
      kind: Foo
    - group: group3
...
func TestMergedGVKs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.gvks1 != nil {
				ext1 = map[string]interface{}{"x-nholuongut-group-version-kind": tt.gvks1}
			}
			if tt.gvks2 != nil {
				ext2 = map[string]interface{}{"x-nholuongut-group-version-kind": tt.gvks2}
			}
