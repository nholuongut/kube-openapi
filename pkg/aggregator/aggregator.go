...
const gvkKey = "x-nholuongut-group-version-kind"
...
// deepEqualDefinitionsModuloGVKs compares s1 and s2, but ignores the x-nholuongut-group-version-kind extension.
...
// mergedGVKs merges the x-nholuongut-group-version-kind slices and returns the result, and whether
// s1's x-nholuongut-group-version-kind slice was changed at all.
