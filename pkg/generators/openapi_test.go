/*
Copyright 2016 The nholuongut Authors.
...
// +k8s:openapi-gen=x-nholuongut-type-tag:type_test
type Blah struct {
	// A simple string
	String string
	// A simple int
	...
	// +k8s:openapi-gen=x-nholuongut-member-tag:member_test
...
"x-nholuongut-member-tag": "member_test",
},
},
SchemaProps: spec.SchemaProps{
...
VendorExtensible: spec.VendorExtensible{
Extensions: spec.Extensions{
"x-nholuongut-patch-merge-key": "pmk",
"x-nholuongut-patch-strategy": "merge",
},
},
SchemaProps: spec.SchemaProps{
...
VendorExtensible: spec.VendorExtensible{
Extensions: spec.Extensions{
"x-nholuongut-type-tag": "type_test",
},
},
},
}
...
VendorExtensible: spec.VendorExtensible{
Extensions: spec.Extensions{
"x-nholuongut-list-map-keys": []interface{}{
"port",
"protocol",
},
"x-nholuongut-list-type": "map",
},
},
SchemaProps: spec.SchemaProps{
