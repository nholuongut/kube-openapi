...
//
// Using this tag will generate the following OpenAPI extension:
//  "x-nholuongut-list-map-key": "name"
...
// This default will still generate an OpenAPI extension with key: "x-nholuongut-map-type".
//
